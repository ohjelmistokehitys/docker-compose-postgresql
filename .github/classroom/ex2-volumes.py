...
check("volumes" in result, "You must define required volumes for both of the services")

check("/var/lib/postgresql" in result, "Use /var/lib/postgresql as the volume for the postgres service")
